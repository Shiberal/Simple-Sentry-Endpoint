...
/**
 * Runs HTTP GET checks for monitors that have pingUrls set.
 *
 * @param {{ monitorId?: number, projectId?: number }} filters
 */
export async function runMonitorHttpPings(filters = {}) {
  const baseWhere = {};
  if (filters.monitorId != null) {
    baseWhere.id = filters.monitorId;
  }
